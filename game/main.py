...
def adjust_speed(score):
    ...
    if score < 500:
        return 500  # intervalo de 200ms para pontuação abaixo de 500
    elif score < 1000:
        return 400  # intervalo de 150ms para pontuação entre 500 e 1000
    elif score < 1500:
        return 300  # intervalo de 120ms para pontuação entre 1000 e 1500
    else:
        return 150  # intervalo de 100ms para pontuação acima de 1500
